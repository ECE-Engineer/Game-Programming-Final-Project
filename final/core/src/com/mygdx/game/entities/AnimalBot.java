...
public class AnimalBot extends Enemy {
    ...
    private final float ATTACK_ZONE = 944;
    private int healthBar = 3;
    private boolean visibility;

    public AnimalBot(Alex241Intro game, Vector2 initPos) {
        super.game = game;
        ...
        super.setTexture(new Texture("Animal.png"));
