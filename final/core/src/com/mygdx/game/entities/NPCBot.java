...
public class NPCBot extends Enemy {
    ...
    private final float ATTACK_ZONE = 641;
    private int healthBar = 3;
    private boolean visibility;

    public NPCBot(Alex241Intro game, Vector2 initPos) {
        super.game = game;
        ...
        super.setTexture(new Texture("NPC.png"));
